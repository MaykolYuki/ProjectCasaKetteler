...
$leeme = @(
    ...
    "",
    "     Lo mas simple es pasarles este enlace, que se abre desde el",
    "     celular y tiene un solo boton:",
    "",
    "         https://casaketteler.netlify.app",
    "",
    "     Las instrucciones de instalacion estan en esa misma pagina.",
    "     Tambien se puede repartir el APK de 'app-residentes' a mano.",
    "",
    "",
